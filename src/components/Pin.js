          ...
          >
            ...
            <div className='flex items-center justify-between'>
              ...
              {alreadySaved ? (
                ...
                text-base rounded-3xl hover:shadow-md outlined-none'>
                 {save?.length} Saved
                </button>
              ):(
                <button type='button'
            ...
            <div className='flex justify-between items-center gap-2 w-full'>
              ...
              {postedBy?._id === user?.sub && (
                ...
                className="bg-white p-2 rounded-full w-8 h-8 flex items-center
                 justify-center text-dark opacity-75 hover:opacity-100 outline-none">
                  <AiTwotoneDelete/>
                </button>
              )}
            </div>
